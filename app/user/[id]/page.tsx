    ...
    <React.Fragment>
      ...
      <div className="hero min-h-screen bg-base-200 min-w-fit">
        <div className="hero-content flex-col lg:flex-row">
          <img
            src="https://cdn.clippingpath.in/wp-content/uploads/2019/05/Shoe-product-photography.jpg"
          ...
          <div>
            ...
            <br />
            <button className="btn btn-warning mx-2">Grab now</button>
            <Link href="/user">
            ...
            <Link href="/">
              <button className="btn btn-warning mx-2">Back to Home</button>
            </Link>
          </div>
        </div>
      </div>
